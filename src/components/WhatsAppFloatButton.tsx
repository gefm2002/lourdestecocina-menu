...
export const WhatsAppFloatButton = ({ site }: WhatsAppFloatButtonProps) => (
  <a
    href={`https://wa.me/${site.contact.whatsapp}?text=Hola%20Lourdes%20te%20Cocina%2C%20quiero%20hacer%20un%20pedido.%20%C2%BFMe%20pas%C3%A1s%20disponibilidad%20de%20hoy%3F`}
    target="_blank"
    rel="noopener"
    ...
    aria-label="WhatsApp Lourdes te Cocina"
  >
