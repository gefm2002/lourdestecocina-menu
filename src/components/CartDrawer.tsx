...
export const CartDrawer = ({ site, isOpen, onClose }: CartDrawerProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-end bg-black/40 p-0 lg:items-center lg:justify-center lg:p-6">
      <div className="h-full w-full bg-secondary p-6 shadow-soft lg:h-auto lg:max-h-[90vh] lg:max-w-2xl lg:rounded-ui lg:border lg:border-black/10">
        ...
        <div className="mt-6 space-y-4 overflow-y-auto lg:max-h-[55vh]">
          {items.length === 0 && (
          ...
          {items.map((item) => (
            <div
              key={item.id}
              className="rounded-ui border border-black/10 bg-white px-4 py-3"
            >
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <input
                  className="ml-auto w-full rounded-full border border-black/10 px-3 py-1 text-xs"
        ...
        <div className="mt-6 rounded-ui border border-black/10 bg-white p-4">
        ...
        <div className="mt-6 space-y-3">
          ...
          <textarea
            className="min-h-[80px] w-full rounded-2xl border border-black/10 px-4 py-3 text-sm"
        ...
        <div className="mt-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <a
            ...
            className={`inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-semibold text-white ${
              isValid && items.length > 0 ? "bg-accent" : "bg-muted/40 pointer-events-none"
            }`}
          >
